        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: isDark ? '#1E293B' : '#FFFFFF' }]}>
            <View style={styles.iconContainer}>
              <MaterialCommunityIcons name="code-braces-box" size={64} color="#8B5CF6" />
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.feedbackReviewModal, { backgroundColor: isDark ? '#1E293B' : '#FFFFFF' }]}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 8 }}>
              <MaterialCommunityIcons name="file-document-outline" size={22} color={isDark ? '#8B5CF6' : '#8B5CF6'} style={{ marginRight: 10 }} />
            ...
            <ScrollView style={styles.feedbackReviewScroll} showsVerticalScrollIndicator={false}>
              {quizFeedback.map((item, index) => (
                <View key={index} style={[styles.feedbackItem, { backgroundColor: isDark ? '#0F172A' : '#F8FAFC', borderLeftColor: '#EF4444', borderLeftWidth: 4 }]}>
...
const styles = StyleSheet.create({
  ...
  scoreCard: { alignItems: 'center', gap: 16, width: '100%', paddingVertical: 28, paddingHorizontal: 24, borderRadius: 24, backgroundColor: 'rgba(139, 92, 246, 0.08)', borderWidth: 1.5, borderColor: 'rgba(139, 92, 246, 0.2)' },
