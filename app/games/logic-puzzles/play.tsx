        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: isDark ? '#1E293B' : '#FFFFFF' }]}>
            <View style={styles.iconContainer}>
              <MaterialCommunityIcons name="puzzle-outline" size={64} color="#3B82F6" />
            </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.feedbackReviewModal, { backgroundColor: isDark ? '#1E293B' : '#FFFFFF' }]}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 8 }}>
              <MaterialCommunityIcons name="file-document-outline" size={22} color={isDark ? '#3B82F6' : '#3B82F6'} style={{ marginRight: 10 }} />
...
const styles = StyleSheet.create({
  ...
  iconContainer: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(59, 130, 246, 0.15)', alignItems: 'center', justifyContent: 'center', marginBottom: 8, shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
  resultsTitle: { fontSize: 32, fontWeight: '900', textAlign: 'center', letterSpacing: -0.5 },
  scoreCard: { alignItems: 'center', gap: 16, width: '100%', paddingVertical: 28, paddingHorizontal: 24, borderRadius: 24, backgroundColor: 'rgba(59, 130, 246, 0.08)', borderWidth: 1.5, borderColor: 'rgba(59, 130, 246, 0.2)' },
  ...
  closeButton: { backgroundColor: '#3B82F6', borderRadius: 20, paddingVertical: 18, paddingHorizontal: 32, width: '100%', shadowColor: '#3B82F6', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.25, shadowRadius: 12, elevation: 6 },
  ...
  feedbackItem: { padding: 16, borderRadius: 12, marginBottom: 12, gap: 8, borderLeftColor: '#3B82F6', borderLeftWidth: 4 },
