...
export default function RegisterScreen() {
  ...
  const roleLabel =
    role === 'Teacher' ? t('register.role_teacher') : t('register.role_student');
...
const getStyles = (colorScheme: any) => {
  ...
  return StyleSheet.create({
    ...
    cardTitle: { fontSize: 26, fontWeight: '700', textAlign: 'center', color: palette.text },
    form: { gap: 20 },
    field: { gap: 8 },
    ...
    inputField: { flex: 1, fontSize: 15, color: palette.text, paddingVertical: 12 },
    inputStandalone: {
      backgroundColor: palette.input,
      borderRadius: 16,
      borderWidth: 1,
    ...
    selectText: { fontSize: 15, fontWeight: '600', color: palette.text },
    selectIcon: { fontSize: 18, color: palette.muted },
    primaryButton: {
      marginTop: 12,
    ...
    modalTitle: { fontSize: 18, fontWeight: '700', color: palette.text, textAlign: 'center' },
    modalOptions: { gap: 12 },
    modalOption: {
      borderRadius: 16,
      borderWidth: 1,
    ...
    modalOptionSelected: { borderColor: '#2563EB' },
    modalOptionText: { fontSize: 15, fontWeight: '600', color: palette.text },
    ...
    modalSecondaryText: { color: palette.text, fontWeight: '600' },
  });
};
